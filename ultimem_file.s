...
#ifdef 29F040
MFR_ID	= $01			; manufacturer ID for AM29F040B
DEV_ID	= $a4			; device ID for AM29F040B
f000	= flash			; flash address 0
f001	= flash + 1		; flash address 1
f555	= flash + $555		; flash address $555
f2aa	= flash + $2aa		; flash address $2aa
#else
MFR_ID	= $01			; manufacturer ID for 29LV640E
DEV_ID	= $7e			; device ID for 29LV640EB
f000	= flash	+ 1	; flash address 1 for mx29lv640
f001	= flash + 2		; flash address 2 for mx29lv640
f555	= flash + $aaa		; flash address $aaa
f2aa	= flash + $555		; flash address $555
;MFR_ID	= $c2			; manufacturer ID for 29LV640E
;DEV_ID	= $cb			; device ID for 29LV640EB
;f000	= flash	+ 1	; flash address 1 for mx29lv640
;f001	= flash + 2		; flash address 2 for mx29lv640
;f555	= flash + $aaa		; flash address $aaa
;f2aa	= flash + $555		; flash address $555
...
program	jsr read		; parameter => size (16 bits)
  ...
  and #$e0 ; mask off all but top 3 bits (I think...)
  sta tmp
  jsr read
  sta ultimem+12
  lda #0
...
;	and #$44		; bits 2 and 6 ($44) toggling?
	and #$40		; bits 2 and 6 ($44) toggling?
;	eor #$44
